...
_C.run.visdom        = (False              , "visdom")
_C.run.visdom_port   = (12322              , "visdom_port")
_C.run.visdom_freq   = (10                 , "visdom_freq")

_C.model = CN()
_C.model.version    = ("v2-timm"             , "model_version")
_C.model.pretrained = (False                 , "pretrained")

_C.curriculum = CN()
_C.curriculum.milestones            = ([20, 70]      , "milestones")
_C.curriculum.load_difficulty_real  = (""            , "load_difficulty_real")
_C.curriculum.load_difficulty_fake  = (""            , "load_difficulty_fake")
_C.curriculum.pace_function         = ("pace-1"      , "pace_function")
_C.curriculum.curriculum_pretrained = ("/workspace/SBI_Deepfake/results/20250514v1_timmswinv2_normalize/checkpoint.pth", "curriculum_pretrained")

_C.aug = CN()
_C.aug.crop      = ("center", "crop")
_C.aug.normalize = (False   , "normalize")
...
def get_cfg():
    ...
    parser.add_argument("--visdom_freq", type=int)
    parser.add_argument("--model_version", type=str)
    parser.add_argument("--pretrained", action="store_true")
    parser.add_argument("--milestones", nargs="+", type=int)
    parser.add_argument("--load_difficulty_real", type=str)
    parser.add_argument("--load_difficulty_fake", type=str)
    parser.add_argument("--pace_function", type=str)
    parser.add_argument("--curriculum_pretrained", type=str)
    parser.add_argument("--crop", type=str, choices=["center", "random"])
